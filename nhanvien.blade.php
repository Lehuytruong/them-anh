    ...
    <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
      <div class="container-fluid">
        <div class="navbar-wrapper">
          <button type="button" class="btn btn-success" ><a href="{{url("nhan-vien/create") }}" style="color: white">Thêm Giáo Viên</a></button>
        </div>
              ...
              <table class="table table-hover">
                ...
                @foreach($teachers as $teacher)
                  <tr>
                    ...
                    <td><img src="{{asset($teacher->teacher_image)}}" width="80" height="80" /> </td>
                    <td>{{$teacher->teacher_name}}</td>
                    <td>{{$teacher->teacher_age}}</td>
                    <td>{{$teacher->teacher_gender}}</td>
                    <td>{{$teacher->getLop->lop_name}}</td>
                    <td><a class="btn btn-danger" style="background: #1b5e20"  href="{{url("nhan-vien/edit?teacher_id=".$teacher->teacher_id)}}">Sửa thông tin</a> </td>
                    <td><a class="btn btn-danger" onclick="return confirm('Are you sure?');" href="{{url("nhan-vien/delete/".$teacher->teacher_id)}}">Xóa nhân viên</a> </td>
                  </tr>
                @endforeach
                </tbody>
              </table>
